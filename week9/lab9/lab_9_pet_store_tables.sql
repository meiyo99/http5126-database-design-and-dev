...
CREATE TABLE stock_item (
  ...
  -- this constraint specifies that inventory for any item cannot be less than 0, which is why we get an error when we try to deduct from the inventory of 'Luxury cat bed'.
);
